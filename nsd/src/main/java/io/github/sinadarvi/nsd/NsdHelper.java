...
public class NsdHelper implements DiscoveryTimer.OnTimeoutListener {
     ...
     * and {@link io.github.sinadarvi.nsd.NsdListener#onNsdDiscoveryFinished()} will be called.
     ...
     *
     * @param serviceType Service type, eg. "_http._tcp.". Typical names can be obtain from {@link io.github.sinadarvi.nsd.NsdType}.
     */
